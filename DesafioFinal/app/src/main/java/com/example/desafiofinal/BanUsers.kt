...
import MiAdaptador.AdaptadorBan
import Model.User
...
class BanUsers : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        miRecyclerView = findViewById(R.id.rvBan)// as RecyclerView
        miRecyclerView.setHasFixedSize(true)
        miRecyclerView.layoutManager = LinearLayoutManager(this)

        try {
            recuperarDatos(object : BanUsers.RolCallback {
    ...
    private fun obtenerDatos(datos: MutableList<DocumentSnapshot>) {
        ...
        var miAdapter = AdaptadorBan(miArray, this)
